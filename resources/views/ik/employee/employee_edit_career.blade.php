                        ...
                        <div class="kt-portlet">
                            <div class="kt-portlet__head">
                                <div class="kt-portlet__head-label">
                                    <h3 class="kt-portlet__head-title">Kariyer</h3>
                                </div>
                            </div>
                                                ...
                                                <div class="col-lg-9 col-xl-6">
                                                    <div class="input-group">
                                                        <select multiple="" class="form-control" id="exampleSelect2">
                                                            ...
                                                            <option>Muahsebe</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div> <div class="form-group form-group-last row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">Maaş</label>
                                                <div class="col-lg-9 col-xl-6">
                                                    <input class="form-control" type="text" value="1000.00 TL">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
