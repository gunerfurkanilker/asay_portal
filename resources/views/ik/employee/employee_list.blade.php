    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Tabbed Subheader</h3>
                <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                <span class="kt-subheader__desc">#XRS-45670</span>
                <a href="ik/employee/add" class="btn btn-label-warning btn-bold btn-sm btn-icon-h kt-margin-l-10">
                    Çalışan Ekle
                </a>
                            ...
                            <div class="kt-widget__body">
                                <div class="kt-widget__item">
                                    ...
                                    <div class="kt-widget__contact">
                                        ...
                                        <span class="kt-widget__data">İzmir</span>
                                    </div>
                                </div>
                            </div>
                            <div class="kt-widget__footer">
                                <a href="{{route("employee_edit",["id"=>1])}}" class="btn btn-label-brand btn-lg btn-upper">Detay</a>
                            </div>
                        </div>
