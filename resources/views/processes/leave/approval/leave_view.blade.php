                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions">
                                <a class="btn btn-brand btn-bold btn-sm" href="{{route("leave_approval_edit",["leave_id"=>1])}}">Düzenle</a>
                            </div>
                    ...
                    <div class="kt-form kt-form--label-right">
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group form-group-xs row">
                                <label class="col-4 col-form-label">İzin Türü:</label>
                                <div class="col-8">
                                    <span class="form-control-plaintext kt-font-bolder">Yıllık İzin</span>
                                </div>
                            </div>
                            <div class="form-group form-group-xs row">
                                <label class="col-4 col-form-label">İzin Sebebi:</label>
                                <div class="col-8">
                                    <span class="form-control-plaintext kt-font-bolder">izin açıklaması ve diğer</span>
                                </div>
                            </div>
                        </div>
                        <div class="kt-portlet__foot">
                            <div class="kt-section kt-section--last">
                                <a href="{{route("leave_approval_list")}}" class="btn btn-success btn-sm btn-bold"> Onayla</a>
                                <a href="{{route("leave_approval_list")}}" class="btn btn-danger btn-sm btn-bold">Reddet</a>
                            </div>
                        </div>
                    </div>
                </div>
