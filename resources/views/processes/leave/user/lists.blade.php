                    ...
                    <div class="kt-section__content">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><a class="kt-link" href="{{route("leave_view",["leave_id"=>1])}}">Serkan Erdinç</a></td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td><a class="kt-link" href="{{route("leave_view",["leave_id"=>3])}}">Serkan Erdinç</a></td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td><a class="kt-link" href="{{route("leave_view",["leave_id"=>4])}}">Serkan Erdinç</a></td>
                                ...
                                <tr>
                                    <td>4</td>
                                    <td><a class="kt-link" href="{{route("leave_view",["leave_id"=>5])}}">Serkan Erdinç</a></td>
                                    <td>11.09.2019 09:00:00</td>
                                    <td>12.09.2019 09:00:00</td>
                                    <td>1 Gün</td>
                                    <td>Yıllık İzin</td>
